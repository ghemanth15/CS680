...
public class ApfsLinkTest {
	...
	@Test
	public void verifyLinkEquality_M() {
	...
	@Test
	public void verifyLinkEquality_N() {
	...
	@Test
	public void isDirectoyTestingM() {
		assertFalse(m.isDirectory());
	}
	
	@Test
	public void isFileTestingM() {
		assertFalse(m.isFile());
	}
	
	@Test
	public void isLinkTestingM() {
		assertTrue(m.isLink());
	}
	
	@Test
	public void getTargetTestingM() {
		assertSame(bin, m.getTarget());
	}
	
	@Test
	public void setTargetTestingM() {
		m.setTarget(apps);
