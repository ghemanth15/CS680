...
public class ApfsDirectoryTest {
	...
	@Test
	public void isDirTestingRoot() {
		assertTrue(root.isDirectory());
	}
	
	@Test
	public void isFileTestingRoot() {
		assertFalse(root.isFile());
	}
	
	@Test
	public void isLinkTestingRoot() {
		assertFalse(root.isLink());
	}
	
	@Test
	public void appendChildrenTestingRoot() {
		assertSame(root, apps.getParent());
	}
	
	@Test
	public void appendChildrenTestingHome() {
		assertSame(home, c.getParent());
	}
	
	@Test
	public void countChildrenTestingRoot() {
		assertEquals(3, root.countChildren());;
	}
	
	@Test
	public void countChildrenTestingHome() {
	...
	@Test
	public void getSubDirOfRootBasedReverseAlphabetical() {
		ApfsDirectory[] expected = new ApfsDirectory[3];
		expected[0] = home;
		expected[1] = bin;
		expected[2] = apps;
	...
	@Test
	public void getSubDirOfRootBasedElementKind() {
		ApfsDirectory[] expected = new ApfsDirectory[3];
		expected[0] = apps;
		expected[1] = bin;
		expected[2] = home;
	...
	@Test
	public void getLinksTestingHome() {
		assertSame(m, home.getLinks().get(0));
	}
	
	@Test
	public void getLinksTestingPictures() {
		assertSame(n, pictures.getLinks().get(0));
	}
	
	@Test
	public void getTotalSizeTestingRoot() {
		assertEquals(150, root.getTotalSize());
	}
	
	@Test
	public void getTotalSizeTestingHome() {
