...
public class PrimeGeneratorTest {
    ...
    public void primesBetween1and10(){
        ...
        Assertions.assertEquals(expectedNumberOfPrimes, actualNumberOfPrimes);
        Assertions.assertArrayEquals(primes.toArray(), expectedPrimes.toArray());
    }
    ...
    @Test
    public void primesBetween20and30(){
        PrimeGenerator gen = new PrimeGenerator(20, 30);
        gen.generatePrimes();
        LinkedList<Long> primes = gen.getPrimes();
        Long[] expectedPrimes = new Long[]{23L, 29L};
        int expectedNumberOfPrimes = expectedPrimes.length;
        int actualNumberOfPrimes = primes.size();
        Assertions.assertEquals(expectedNumberOfPrimes, actualNumberOfPrimes);
        Assertions.assertArrayEquals(primes.toArray(), expectedPrimes);
    }
}
